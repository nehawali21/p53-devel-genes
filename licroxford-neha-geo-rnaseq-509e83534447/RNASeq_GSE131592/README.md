...
This version is a clone of the OAC Trial RNASeq pipeline.

This nextflow pipeline will process fastq.gz files from bulk RNA sequencing, producing count tables using STAR and featureCounts and
